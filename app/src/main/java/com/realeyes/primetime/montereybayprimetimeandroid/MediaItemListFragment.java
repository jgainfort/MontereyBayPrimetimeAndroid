...
/**
 * A list fragment representing a list of MediaItems. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link MediaItemDetailFragment}.
 * <p/>
...
public class MediaItemListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new MediaListAdapter(getActivity(), R.layout.row, MediaContent.ITEMS));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(MediaContent.ITEMS.get(position).title);
    }
